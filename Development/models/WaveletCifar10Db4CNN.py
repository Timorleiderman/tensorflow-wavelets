...
from models.DWT import DWT_Pooling, IWT_UpSampling, DWT_Pooling_Db4 ,IWT_UpSampling_Db4
from keras.layers import Input, Conv2D, MaxPooling2D, Dense, Flatten, BatchNormalization, Activation, Dropout


def WaveletDb4CNN(input_size=(32, 32, 3), nb_classes=10):
    ...
    output = DWT_Pooling_Db4()(output)  # dwt
